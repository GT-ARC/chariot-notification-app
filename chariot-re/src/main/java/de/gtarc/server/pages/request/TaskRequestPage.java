...
@WebServlet(value = "/taskrequest")
public class TaskRequestPage extends AbstractPage {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Mustache m = new DefaultMustacheFactory().compile("templates/taskRequest.mustache");
